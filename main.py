...
def check(a,b,c):
    ...
    if a != b and a != c and b != c:
        return 0
print(check(int(input("Введите значения: ")),int(input()),int(input())))
...
n = int(input("Введите количество этажей пирамиды: ")) + 1
for i in range(1, n + 1):
...
num = int(input("Введите количество этажей пирамиды: "))
